...
\begin{enumerate}
	\item The sides of a triangle are $3x+4y,4x+3y \text{ and } 5x+5y \text{ where } x,y>0$ then the triangle is \hfill\brak{2002}
...
\end{multicols}
    ...
    \item In a triangle with sides $a,b,c,r_1>r_2>r_3$ (which are ex-radius) then \hfill\brak{2002}
...
\item In a triangle $\vec{ABC}$, medians $\vec{AD}$ and $\vec{BE}$ are drawn. If $\vec{AD}=4,\angle{\vec{DAB}}=\frac{\pi}{6} \text{ and } \angle{\vec{ABE}}=\frac{\pi}{3},$ then the area of the $\Delta{\vec{ABC}}$ is \hfill\brak{2003}
\begin{multicols}{4}
\begin{enumerate}
        \item $\frac{64}{3}$                    
        \item $\frac{8}{3}$ 
...
\item If in $\Delta{\vec{ABC}}\;a\cos^2\brak{\frac{\vec{C}}{2}} + c\cos^2\brak{\frac{\vec{A}}{2}} = \frac{3b}{2},$ then the sides $a,b\text{ and }c$ \hfill\brak{2003}
\begin{multicols}{4}
\begin{enumerate}
        \item satisfy $a+b=c$                    
        \item are in A.P. 
...
\item In a triangle $ABC$, let $\angle{C}=\frac{\pi}{2}.$ If $r$ is the inradius and $R$ is the circumradius of the triangle $ABC,$ then $2\brak{R+r}$ equals \hfill\brak{2005}
\begin{multicols}{4}
\begin{enumerate}
        \item $b+c$                    
        \item $a+b$ 
...
\item A tower stand at the centre of a circular park. $\vec{A}$ and $\vec{B}$ are two points on the boundary of the park such that $\vec{AB}\brak{=a}$ subtends an angle of $60\degree$ at the foot of the tower, and the angle of elevation of the top of the tower from $\vec{A}$ or $\vec{B}$ is $30\degree.$ The height of the tower is \hfill\brak{2007}
\begin{multicols}{4}
\begin{enumerate}
        \item $\frac{a}{\sqrt{3}}$                    
        \item $a\sqrt{3}$ 
...
\item Let a vertical tower $\vec{AB}$ have its end $\vec{A}$ on the level ground. Let $\vec{C}$ be the  mid-point of $\vec{AB}$ and $\vec{P}$ be a point on the ground such that $\vec{AP}=2\vec{AB}.$ If $\angle{BPC}=\beta,$ then $\tan \beta$ is equal to: \hfill\brak{JEE M 2017}
\begin{multicols}{4}
\begin{enumerate}
        \item $\frac{4}{9}$                    
        \item $\frac{6}{7}$ 
...
\item $\vec{PQR}$ is a triangular park with $\vec{PQ}=\vec{PR}=200m$. A T.V. tower stands at the mid-point of $\vec{QR}$. If the angles of the elevation of the top of the tower at $\vec{P,Q \text{ and } R}$ are respectively $45\degree , 30\degree \text{ and } 30\degree,$ then the height of the tower \brak{in\:m} is: \hfill\brak{JEE M 2018}
\begin{multicols}{4}
\begin{enumerate}
        \item $50$                    
        \item $100\sqrt{3}$ 
